...
Vagrant.configure('2') do |config|
    ...
    config.vm.define "ansible", primary: true do |machine1|
        ...
        machine1.vm.network "private_network", ip: "192.168.10.120"
    ...
    config.vm.define "server1", primary: false do |machine2|
        ...
        machine2.vm.network "private_network", ip: "192.168.10.125"
    ...
    config.vm.define "server2", primary: false do |machine3|
        ...
        machine3.vm.network "private_network", ip: "192.168.10.126"
